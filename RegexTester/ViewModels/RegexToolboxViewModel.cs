...
namespace RegexTester.ViewModels
{
    ...
    public partial class RegexToolboxViewModel : ObservableObject
    {
        ...
        [
            ...
            ("common-tokens", "Common Tokens", "M12 2.8 L14.3 7.5 L19.5 8.3 L15.7 12 L16.6 17.2 L12 14.8 L7.4 17.2 L8.3 12 L4.5 8.3 L9.7 7.5 Z"),
            ("general-tokens", "General Tokens", "M16 12 H3 M16 18 H3 M10 6 H3 M21 18 V8 C21 6.9 20.1 6 19 6 H14 M16 8 L14 6 L16 4"),
            ("anchors", "Anchors", "M12 22 V8 M5 12 H2 A10 10 0 0 0 22 12 H19 M12 2 A3 3 0 1 1 12 8 A3 3 0 1 1 12 2"),
            ("meta-sequences", "Meta Sequences", "M12 2 A10 10 0 1 1 12 22 A10 10 0 1 1 12 2 M12 11 A1 1 0 1 1 12 13 A1 1 0 1 1 12 11"),
            ("quantifiers", "Quantifiers", "M8 3 H7 C5.9 3 5 3.9 5 5 V10 C5 11.1 4.1 12 3 12 C4.1 12 5 12.9 5 14 V19 C5 20.1 5.9 21 7 21 H8 M16 3 H17 C18.1 3 19 3.9 19 5 V10 C19 11.1 19.9 12 21 12 C19.9 12 19 12.9 19 14 V19 C19 20.1 18.1 21 17 21 H16"),
            ...
            ("flags-modifiers", "Flags/Modifiers", "M4 15 C5 14 8 14 11 15 C14 16 17 16 20 15 V3 C17 4 14 4 11 3 C8 2 5 2 4 3 Z M4 15 V22"),
            ("substitution", "Substitution", "M14 4 A2 2 0 0 1 16 2 M16 10 A2 2 0 0 1 14 8 M20 2 A2 2 0 0 1 22 4 M22 8 A2 2 0 0 1 20 10 M3 7 L6 10 L9 7 M6 10 V5 C6 3.3 7.3 2 9 2 H10 M2 14 H10 V22 H2 Z")
        ];
        ...
        private void LoadTokens()
        {
            ...
            catch
            {
                ...
                var jsonPath = fallbackPaths.FirstOrDefault(File.Exists);
                if (jsonPath != null)
                {
            ...
            try
            {
                ...
                var items = JsonSerializer.Deserialize<List<RegexToolboxToken>>(json, options) ?? [];
                Tokens.Clear();
                ...
                foreach (var (id, label, iconPathData) in CategoryBlueprint)
                {
        ...
        {
            // TODO: Insert at cursor in Expression-TextBox
            // Das wird später mit MainWindowViewModel gekoppelt
        }
        ...
        private void FilterTokens()
        {
            ...
            var filterByCategory = SelectedCategory != null &&
                                   !string.Equals(SelectedCategory.Id, AllTokensId, StringComparison.OrdinalIgnoreCase);

            var filtered = Tokens.Where(t =>
                (!filterByCategory || t.Category == SelectedCategory!.Id) &&
                (string.IsNullOrWhiteSpace(SearchText) ||
                 t.Label.Contains(SearchText, System.StringComparison.OrdinalIgnoreCase) ||
                 t.Tooltip.Contains(SearchText, System.StringComparison.OrdinalIgnoreCase) ||
                 t.Syntax.Contains(SearchText, System.StringComparison.OrdinalIgnoreCase)));
