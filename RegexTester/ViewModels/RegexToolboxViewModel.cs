...
public partial class RegexToolboxViewModel : ObservableObject
{
    ...
    [ObservableProperty] private ObservableCollection<RegexToolboxCategory> categories = new();

    [ObservableProperty] private ObservableCollection<RegexToolboxToken> filteredTokens = new();

    [ObservableProperty] private string searchText = "";

    [ObservableProperty] private RegexToolboxCategory? selectedCategory;

    [ObservableProperty] private ObservableCollection<RegexToolboxToken> tokens = new();
    ...
    private void LoadTokens()
    {
        ...
        catch
        {
            ...
            if (jsonPath != null) json = File.ReadAllText(jsonPath);
        }

        if (string.IsNullOrWhiteSpace(json)) throw new Exception("Failed to load regex-toolbox-items.json");
        ...
        try
        {
            ...
            {
                if (string.IsNullOrWhiteSpace(t.Label) || string.IsNullOrWhiteSpace(t.Syntax)) continue;
                Tokens.Add(t);
            }
    ...
    private void FilterTokens()
    {
        ...
        var filtered = Tokens.Where(t =>
            ...
            (string.IsNullOrWhiteSpace(SearchText) ||
             ...
             t.Tooltip.Contains(SearchText, StringComparison.OrdinalIgnoreCase) ||
             t.Syntax.Contains(SearchText, StringComparison.OrdinalIgnoreCase)));
